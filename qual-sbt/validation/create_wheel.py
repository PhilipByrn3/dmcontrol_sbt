...
class Spoke:
    def __init__(self, name:str, axle_length:float, side:int,
        ...
        self._spokes = self._mjcf_model.worldbody.add(
            'body', name=f'{name}_spokes', pos=[side*axle_length, 0, 0],
...
class AssembleWheel:
    def __init__(self):
        ...
        slow_side_rubber_ending = False
        fast_side_rubber_ending = False
        
        self._mjcf_model = mjcf.RootElement()
        
        self._axle = Axle(name='axle', axle_length=axle_length, component_mass=component_mass)
        ...
        self._slow_spokes = Spoke(name='slow',
                                  ...
                                  rubber_spoke_ending=slow_side_rubber_ending)
        self._fast_spokes = Spoke(name='fast',
                                  ...
                                  relative_spoke_angle=relative_spoke_angle,
                                  component_mass=component_mass,
                                  rubber_spoke_ending=fast_side_rubber_ending)
        self._mjcf_model.attach(self._slow_spokes._mjcf_model)
        self._mjcf_model.attach(self._fast_spokes._mjcf_model)